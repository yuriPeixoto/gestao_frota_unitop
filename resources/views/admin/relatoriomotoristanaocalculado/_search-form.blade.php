<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatoriomotoristanaocalculado.gerarPdf()"
                :disabled="$store.relatoriomotoristanaocalculado.loading"
                ...
                <span x-show="$store.relatoriomotoristanaocalculado.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriomotoristanaocalculado.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriomotoristanaocalculado.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatoriomotoristanaocalculado.gerarExcel()"
                :disabled="$store.relatoriomotoristanaocalculado.loading"
                ...
                <x-icons.magnifying-glass x-show="!$store.relatoriomotoristanaocalculado.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriomotoristanaocalculado.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
