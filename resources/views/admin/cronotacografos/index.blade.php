            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative inline-block text-left" x-data="{ helpOpen: false }">
                    ...
                    <div x-show="helpOpen" @click.away="helpOpen = false"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Cronotacógrafos
                                </p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode visualizar todos os cronotacógrafos cadastrados,
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <!-- Search Form -->
                @include('admin.cronotacografos._search-form')
                <!-- Results Table with Loading -->
                @include('admin.cronotacografos._table')
            </div>
        </div>
    </div>

    @push('scripts')
        @include('admin.cronotacografos._scripts')
    @endpush
</x-app-layout>
