<form method="GET" action="#" class="space-y-4">
    ...
    <div class="flex w-full gap-2">
        ...
        <div class="w-full">
            <x-forms.input name="id_tranferencia" label="Cód. Transferência" value="{{ request('id_tranferencia') }}" />
        </div>
        {{-- Status --}}
    ...
    <div class="flex justify-between mt-4">
        <div>
            ...
            <a href="{{ route('admin.transferenciaEntreEstoque.export.pdf', request()->only(['id_tranferencia', 'data_inclusao', 'data_final'])) }}"
            ...
            {{-- Usar o novo componente de botões de exportação --}}
            <a href="{{ route('admin.transferenciaEntreEstoque.export.csv', request()->only(['id_tranferencia', 'data_inclusao', 'data_final'])) }}"
                class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            ...
            {{-- Usar o novo componente de botões de exportação --}}
            <a href="{{ route('admin.transferenciaEntreEstoque.export.xls', request()->only(['id_tranferencia', 'data_inclusao', 'data_final'])) }}"
                class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            ...
            {{-- Usar o novo componente de botões de exportação --}}
            <a href="{{ route('admin.transferenciaEntreEstoque.export.xml', request()->only(['id_tranferencia', 'data_inclusao', 'data_final'])) }}"
                class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
