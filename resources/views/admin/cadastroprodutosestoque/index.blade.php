    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            ...
            <div class="flex items-center space-x-4">
                ...
                @endif
                <a href="{{ route('admin.cadastroprodutosestoque.create') }}"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Esta tela exibe os produtos cadastrados. Utilize o botão "Cadastrar Produto" para
                                    adicionar um novo registro. Você pode editar ou excluir produtos utilizando as ações
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="p-6 bg-white border-b border-gray-200">
                <!-- Formulário de Busca -->
                @include('admin.cadastroprodutosestoque._search-form')

                <!-- Tabela com Carregamento -->
                @include('admin.cadastroprodutosestoque._table')
            </div>
        </div>
    </div>
</x-app-layout>
