<script>
    document.addEventListener('alpine:init', () => {
        Alpine.store('relatorioPecasUtilizadas', {
            loading: false,
            ...
            async gerarPdf() {
                ...
                try {
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriopecasutilizadasos/gerarpdf', dados);
                    const blob = await response.blob();

                    this.fazerDownload(blob, `relatorio_pecas_utilizadas_os${new Date().toISOString().slice(0,10)}.pdf`);
            ...
            async gerarExcel() {
                ...
                try {
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriopecasutilizadasos/gerarexcel', dados);
                    const blob = await response.blob();

                    this.fazerDownload(blob, `relatorio_pecas_utilizadas_os${new Date().toISOString().slice(0,10)}.xls`);
