<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <x-forms.smart-select name="id_bomba" label="Bomba" placeholder="Selecione a bomba..." :options="$bomba"
                asyncSearch="false" />
        </div>

        <div>
            <x-forms.smart-select name="id_tipo_combustivel" label="Tipo de Combustível"
                placeholder="Selecione o tipo de combustível..." :options="$tipoCombustivel" asyncSearch="false" />
        </div>
    </div>
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.utils.listagemencerrantes()" :disabled="$store.utils.loading"
            ...
            <button type="button" x-on:click="$store.utils.listagemencerrantesExcel()" :disabled="$store.utils.loading"
                ...
                <!-- Texto do botão -->
                <span x-text="$store.utils.loading ? 'Gerando...' : 'Gerar Excel'"></span>
            </button>
        </div>
    </div>
</div>