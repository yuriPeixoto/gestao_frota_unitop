<form method="GET" action="{{ route('admin.aprovacaoimobilizadogestor.index') }}" class="space-y-4"
    hx-get="{{ route('admin.aprovacaoimobilizadogestor.index') }}" hx-target="#results-table" hx-select="#results-table"
