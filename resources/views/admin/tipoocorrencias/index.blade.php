    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('admin.tipoocorrencias.create') }}"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">
                                    Ajuda - Tipo Ocorrência
                                </p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Está tela tem como finalidade exibir os registros de tipo de Ocorrência.
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="p-6 bg-white border-b border-gray-200">
                <!-- Search Form -->
                @include('admin.tipoocorrencias._search-form')

                <!-- Results Table -->
                <div class="mt-6 overflow-x-auto" id="results-table">

                    <div class="mt-6 overflow-x-auto">
                        @include('admin.tipoocorrencias._table')
                    </div>
                </div>
            </div>
        </div>
