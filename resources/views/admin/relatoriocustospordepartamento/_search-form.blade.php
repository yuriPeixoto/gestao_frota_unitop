<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <x-forms.smart-select name="id_departamento" label="Departamento:" value="{{ request('id_departamento') }}"
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatoriocustospordepartamento.gerarPdf()"
                :disabled="$store.relatoriocustospordepartamento.loading"
                ...
                <span x-show="$store.relatoriocustospordepartamento.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriocustospordepartamento.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriocustospordepartamento.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatoriocustospordepartamento.gerarExcel()"
                :disabled="$store.relatoriocustospordepartamento.loading"
                ...
                <x-icons.magnifying-glass x-show="!$store.relatoriocustospordepartamento.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriocustospordepartamento.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
