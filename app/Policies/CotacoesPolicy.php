...
class CotacoesPolicy
{
    ...
    /**
     * Determine whether the user can merge (juntar) cotações.
     */
    public function juntar(User $user): bool
    {
        // Compradores e administradores podem juntar cotações
        return $user->hasRole('Comprador') ||
            $user->hasRole('Administrador do Módulo Compras') ||
            $user->hasPermission('editar_solicitacao_compra');
    }
}
