<div class="space-y-6">
    <div class="bg-gray-50 p-4 rounded-lg">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Tipo Órgão</h3>
        <div class="grid md:grid-cols-1 gap-4 sm:grid-cols-1">
            <div>
                <label for="descricao_tipo_orgao" class="block text-sm font-medium text-gray-700">Descrição <span
                        class="text-red-500">*</span></label>
                <input type="text" name="descricao_tipo_orgao" id="descricao_tipo_orgao"
                    value="{{ old('descricao_tipo_orgao', $tipoorgaosinistros->descricao_tipo_orgao ?? '') }}"
                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                    required>
                @error('descricao_tipo_orgao')
            ...
            <div class="flex justify-end space-x-3 col-span-full">
                ...
                <button type="submit" id="submitButton"
                    ...
                    <span id="submitText">{{ isset($tipoorgaosinistros) ? 'Atualizar' : 'Salvar' }}</span>
