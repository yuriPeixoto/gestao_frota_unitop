<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatorioatendimentocompra.gerarPdf()"
                :disabled="$store.relatorioatendimentocompra.loading"
                ...
                <span x-show="$store.relatorioatendimentocompra.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatorioatendimentocompra.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioatendimentocompra.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatorioatendimentocompra.gerarExcel()"
                :disabled="$store.relatorioatendimentocompra.loading"
                ...
                <span x-show="$store.relatorioatendimentocompra.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatorioatendimentocompra.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioatendimentocompra.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
