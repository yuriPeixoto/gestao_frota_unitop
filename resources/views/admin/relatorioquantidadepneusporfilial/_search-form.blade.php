<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatorioquantidadepneusporfilial.gerarPdf()"
                :disabled="$store.relatorioquantidadepneusporfilial.loading"
                ...
                <span x-show="$store.relatorioquantidadepneusporfilial.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatorioquantidadepneusporfilial.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioquantidadepneusporfilial.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatorioquantidadepneusporfilial.gerarExcel()"
                :disabled="$store.relatorioquantidadepneusporfilial.loading"
                ...
                <x-icons.magnifying-glass x-show="!$store.relatorioquantidadepneusporfilial.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioquantidadepneusporfilial.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
