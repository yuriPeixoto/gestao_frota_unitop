<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            {{--
            <button type="button" x-on:click="$store.relatorioentradaprodutos.gerarPdf()"
                :disabled="$store.relatorioentradaprodutos.loading"
                ...
                <span x-show="$store.relatorioentradaprodutos.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatorioentradaprodutos.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioentradaprodutos.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button> --}}

            <button type="button" x-on:click="$store.relatorioentradaprodutos.gerarExcel()"
                :disabled="$store.relatorioentradaprodutos.loading"
                ...
                <span x-show="$store.relatorioentradaprodutos.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatorioentradaprodutos.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioentradaprodutos.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
