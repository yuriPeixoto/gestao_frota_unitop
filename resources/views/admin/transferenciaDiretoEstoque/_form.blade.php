<div class="space-y-6 bg-white">
    ...
    @php
    $isCreate = Route::currentRouteName() == 'transferenciaDiretaEstoqueController.create';
    @endphp

    <x-bladewind::tab-group name="tab-transferencia">
        <x-bladewind::tab-body>
            <x-bladewind::tab-content name="dados_transferencia" active="true">
                @include('admin.transferenciaDiretoEstoque._cadastros')
    ...
    <div class="flex justify-end space-x-3 col-span-full">
        ...
        <button type="submit" id="submit-form"
            ...
            {{ isset($transferencia) ? 'Atualizar' : 'Salvar' }}
        </button>
    </div>
</div>

@push('scripts')
@include('admin.transferenciaDiretoEstoque._scripts')
@endpush