<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <x-forms.smart-select name="id_tipo_certificado" label="Tipo Certificado:" placeholder="Selecionar"
            :options="$certificado" value="{{ request('id_tipo_certificado') }}" />
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatoriocertificadoveiculo.gerarPdf()"
                :disabled="$store.relatoriocertificadoveiculo.loading"
                ...
                <span x-show="$store.relatoriocertificadoveiculo.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriocertificadoveiculo.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriocertificadoveiculo.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatoriocertificadoveiculo.gerarExcel()"
                :disabled="$store.relatoriocertificadoveiculo.loading"
                ...
                <span x-show="$store.relatoriocertificadoveiculo.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriocertificadoveiculo.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriocertificadoveiculo.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
