    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Relatório Geral de Sinistros') }}
            </h2>
                ...
                Alpine.store('utils', {
                    ...
                    _coletarDadosFormulario() {
                        return {
                            ...
                            idSinistro: document.getElementById('id_sinistro').value || '',
                        };
                    },
                ...
                `;
                    ...
                    async onGeneratePDF() {
                        ...
                        try {
                            ...
                            const response = await this._fazerRequisicao(
                                '/admin/relatorios/sinistrogeral/onGeneratePdf', data);
                            const blob = await response.blob();

                            this._fazerDownload(blob,
                                `relatorio_geral_sinistro_${new Date().toISOString().split('T')[0]}.pdf`
                            );
                    ...
                    async imprimirSinistroExcel() {
                        ...
                        try {
                            ...
                            const response = await this._fazerRequisicao(
                                '/admin/relatorios/sinistrogeral/onGenerateXls', data);
                            ...
                            const blob = await response.blob();
                            this._fazerDownload(blob,
                                `tabela_sinistro_geral_${new Date().toISOString().split('T')[0]}.xls`);
