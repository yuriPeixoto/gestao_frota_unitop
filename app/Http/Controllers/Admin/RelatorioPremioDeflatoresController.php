...
class RelatorioPremioDeflatoresController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.relatoriopremiodeflatores.index', compact('motorista', 'datainicial', 'datafinal'));
    }
    ...
    public function gerarpdf(Request $request)
    {
        ...
        if (!empty($request['data_inclusao']) && !empty($request['data_final'])) {
            ...
            if (empty($request['nome'])) {
                ...
                $P_in_id_nome  = 'IN';
                $P_id_id_nome  = implode(',', $request['nome']);
            }
            ...
            $parametros = array(
                ...
                'P_in_id_nome' => $P_in_id_nome,
                'P_id_id_nome' => $P_id_id_nome
            );

            //== define pararemetros relatorios  
            $name  = 'premio_deflatores';
    ...
    public function gerarExcel(Request $request)
    {
        if (!empty($request['data_inclusao']) && !empty($request['data_final'])) {
            ...
            if (empty($request['idobtermotorista'])) {
                ...
                $P_in_id_nome  = 'IN';
                $P_id_id_nome = implode(',', $request['idobtermotorista']);
            }
