<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar um cronotacógrafo existente. Altere os campos
    ...
    <div class="bg-white p-4 overflow-hidden shadow-sm sm:rounded-lg">
        <form id="cronotacografoForm" method="POST" action="{{ route('admin.cronotacografos.update', $cronotacografo->id_certificado_veiculo) }}" class="space-y-4"
            ...
            <div class="flex justify-end space-x-4 mt-6">
                ...
                <button type="submit"
                    ...
                    {{ $cronotacografo === 'PUT' ? 'Atualizar' : 'Salvar' }}
                </button>
            </div>
        </form>
    </div>
