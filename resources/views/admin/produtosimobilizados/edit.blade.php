<x-app-layout>
    ...
    @include('admin.produtosimobilizados._form', [
    'action' => route('admin.produtosimobilizados.update', $produtoImobilizado->id_produtos_imobilizados),
    'method' => 'PUT',
    'produtoImobilizado' => $produtoImobilizado,
    ])
</x-app-layout>