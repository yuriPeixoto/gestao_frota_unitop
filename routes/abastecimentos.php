...
use App\Http\Controllers\Admin\AbastecimentoManualController;
use App\Http\Controllers\Admin\AbastecimentoAtsTruckpagManualController;
use App\Http\Controllers\Admin\AjusteKmAbastecimentoController;
use App\Http\Controllers\Admin\BombaController;
use App\Http\Controllers\Admin\PermissaoKmManualController;
use App\Http\Controllers\Admin\TanqueController;
use App\Http\Controllers\Admin\AbastecimentosFaturamentoController;
use App\Http\Controllers\Admin\AfericaoBombaController;
use App\Http\Controllers\Admin\EncerranteController;
use App\Http\Controllers\Admin\EstoqueCombustivelController;
use App\Http\Controllers\Admin\FornecedorController;
use App\Http\Controllers\Admin\InconsistenciasController;
use App\Http\Controllers\Admin\VeiculoController;
use App\Http\Controllers\Admin\MetaTipoEquipamentoController;
use App\Http\Controllers\Admin\RecebimentoCombustivelController;
use App\Http\Controllers\Admin\ValorCombustivelTerceiroController;
use App\Http\Controllers\Admin\AbastecimentoTruckPagController;
use App\Http\Controllers\Admin\ReprocessarIntegracaoController;
use Illuminate\Support\Facades\Route;

Route::post('/abastecimentomanual/processar-lote', [App\Http\Controllers\Admin\AbastecimentoLoteController::class, 'processarLote']);
