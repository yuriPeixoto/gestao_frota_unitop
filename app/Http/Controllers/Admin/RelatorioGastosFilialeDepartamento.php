...
class RelatorioGastosFilialeDepartamento extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.relatoriogastosfilialedepartamento.index', compact('filial', 'departamento'));
    }
    ...
    public function gerarPdf(Request $request)
    {
        try {
            ...
            if ($request->filled(['data_inclusao', 'data_final'])) {
                ...
                $name       = 'relatorio_gasto_por_dep_1';
