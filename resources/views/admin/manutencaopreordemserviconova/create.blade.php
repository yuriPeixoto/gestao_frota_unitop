<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo Cadastro de Pré-O.S. Preencha todos os
                                    campos obrigatórios.
                                </p>
                            </div>
                        </div>
    ...
    @include('admin.manutencaopreordemserviconova._form', [
        'action' => route('admin.manutencaopreordemserviconova.store'),
        'method' => 'POST',
    ])
</x-app-layout>
