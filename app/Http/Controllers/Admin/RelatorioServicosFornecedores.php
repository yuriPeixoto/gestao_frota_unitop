...
class RelatorioServicosFornecedores extends Controller
{
    public function index(Request $request)
    {
        ...
        $fornecedor = $query->select('id_fornecedor as value', 'nome_fornecedor as label')
        ...
        if ($request->filled('id_servico')) {
            $servico->where('id_servico', $request->input('id_servico'));
        }

        return view('admin.relatorioservicosfornecedores.index', compact('fornecedor', 'servico'));
    }
