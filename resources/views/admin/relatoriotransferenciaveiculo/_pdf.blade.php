...
<body>
    <div class="header">
        ...
        <p>Relatório de Transferencia de Veiculos</p>
    ...
    <table>
        <thead>
            <tr>
                <th>Cód Filial Origem</th>
                <th>Cód Filial Destino</th>
                <th>Km Transferencia</th>
                <th>Cód Veiculo</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $resultado->filialOrigem->name ?? ''}}</td>
                <td>{{ $resultado->filialOrigem->name ?? ''}}</td>
                <td>{{ $resultado->km_transferencia ?? ''}}</td>
                <td>{{ $resultado->veiculo->placa ?? ''}}</td>

                <td>{{ $resultado->data_transferencia }}</td>
