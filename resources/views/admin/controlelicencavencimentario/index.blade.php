...
<x-app-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <!-- Search Form -->
                @include('admin.controlelicencavencimentario._search-form')
                ...
                <div class="mt-6 overflow-x-auto relative min-h-[400px]">
                    ...
                    <div id="results-table" class="opacity-0 transition-opacity duration-300">
                        @include('admin.controlelicencavencimentario._table')
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('scripts')
    @include('admin.controlelicencavencimentario._scripts')
