<form method="GET" action="{{ route('admin.cronotacografovencimentario.index') }}" class="space-y-4"
    hx-get="{{ route('admin.cronotacografovencimentario.index') }}" hx-target="#results-table" hx-select="#results-table"
    ...
    <div class="flex justify-between mt-4">
        <div>
            <x-ui.export-buttons route="admin.cronotacografovencimentario" :formats="['pdf', 'csv', 'xls', 'xml']" />
        </div>
