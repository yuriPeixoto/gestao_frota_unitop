<x-app-layout>
            ...
            <div class="flex items-center space-x-4">
                <div class="relative inline-block text-left" x-data="{ helpOpen: false }">
                    ...
                    <div x-show="helpOpen" @click.away="helpOpen = false"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Lançamento de NF de Serviço</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode selecionar serviços para lançar notas fiscais. Utilize os filtros para localizar os serviços desejados, marque os itens e clique em "Gravar NF".
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="p-6 bg-white border-b border-gray-200">
                <!-- Search Form -->
                @include('admin.ordemservicoservicos._search-form')
                ...
                <div class="mt-6 overflow-x-auto relative min-h-[400px]">
                    ...
                    <div id="results-table" class="opacity-0 transition-opacity duration-300">
                        @include('admin.ordemservicoservicos._table')
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('scripts')
        ...
        @include('admin.ordemservicoservicos._scripts')
    @endpush
</x-app-layout>