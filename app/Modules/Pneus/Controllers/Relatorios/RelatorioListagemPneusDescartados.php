...
class RelatorioListagemPneusDescartados extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->filled('descricao_tipo_descarte')) {
            $query->where(
                ...
                $request->input('descricao_tipo_descarte')
            );
        }
        ...
        return view('admin.relatoriolistagempneusdescartados.index', [
    ...
    public function gerarPdf(Request $request)
    {
        ...
        if ($request->filled(['data_inclusao', 'data_final'])) {
            ...
            if (empty($request['id_tipo_descarte'])) {
                $id_tipo_inicial  = '!=';
                $id_tipo_final  = '0';
            } else {
                $id_tipo_inicial  = 'IN';
                $id_tipo_final  = $request['id_tipo_descarte'];
            }
    ...
    public function gerarExcel(Request $request)
    {
        ...
        if ($request->filled(['data_inclusao', 'data_final'])) {
            ...
            if (empty($request['id_tipo_reforma'])) {
                ...
                $id_tipo_inicial = $request['id_tipo_descarte'];
                $id_tipo_final   = $request['id_tipo_descarte'];
            }
