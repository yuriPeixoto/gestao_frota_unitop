<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Ordem de Serviço Preventiva #') . (isset($ordemServico) ? $ordemServico->id_ordem_servico : '') }}
            </h2>
    ...
    @include('admin.ordemservicos._form_preventiva', [
        'action' => route('admin.ordemservicos.update_preventiva', $ordemServico->id_ordem_servico),
        'method' => 'PUT',
