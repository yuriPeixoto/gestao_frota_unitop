    ...
    <div class="p-4 bg-white border-b border-gray-200">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="space-y-6">
                ...
                <form id="recebimentoimobilizado" method="POST" action="{{ $action }}" class="space-y-4">
                    @csrf
                    @if ($method === 'PUT')
                    @method('PUT')
                    @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <label for="id_relacao_imobilizados" class="block text-sm font-medium text-gray-700">Cód.
                                Recebimento Imobilizado</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <textarea id="motivo_transferencia" name="motivo_transferencia"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <x-forms.smart-select name="id_produtos" label="Produto"
                                ...
                                :selected="old('id_produto', $relacaoImobilizados->id_produtos ?? '')" />
                        </div>
                    ...
                    <div class="flex justify-end space-x-3 col-span-full">
                        ...
                        <a href="#"
                            onclick="onEnviaraprovacao({{ $relacaoImobilizados->id_relacao_imobilizados ?? '' }}); return false;"
                        ...
                        <button type="submit" id="submit-form"
                            class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
                            {{ isset($recebimentoimobilizado) ? 'Atualizar' : 'Salvar' }}
                        </button>
                    </div>
...
@push('scripts')
@include('admin.recebimentoimobilizado._scripts')
@endpush