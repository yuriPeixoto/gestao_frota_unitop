    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Editar Desenho') }}: {{ $tipodesenhopneus->descricao_desenho_pneu }}
            </h2>
            <div class="flex items-center space-x-2">
                ...
                <div class="relative inline-block text-left" x-data="{ helpOpen: false }">
                    ...
                    <div x-show="helpOpen" @click.away="helpOpen = false"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Editar Desenho
                                </p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar o tipo de desenho selecionado. Altere os campos
                                    necessários e clique em 'Atualizar' para salvar as modificações, ou 'Cancelar' para
                                    voltar sem alterar.
                                </p>
                            </div>
                        </div>
        ...
        <div>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    'action' => route('admin.tipodesenhopneus.update', $tipodesenhopneus),
                    'method' => 'PUT',
                    'tipodesenhopneus' => $tipodesenhopneus,
                    ])
                </div>
            </div>
        </div>
