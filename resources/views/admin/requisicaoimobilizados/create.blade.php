<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Cadastrar Descarte Imobilizado') }}
            </h2>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo Descarte Imobilizado. Preencha todos os
                                    campos obrigatórios na parte superior e adicione um ou mais descarte imobilizado na
                                    seção
                                    abaixo.
                                </p>
                            </div>
    ...
    'action' => route('admin.requisicaoimobilizados.store'),
    'method' => 'POST',
    ])
</x-app-layout>