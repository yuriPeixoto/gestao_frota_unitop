<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatoriocalibracao.gerarPdf()"
                :disabled="$store.relatoriocalibracao.loading"
                ...
                <span x-show="$store.relatoriocalibracao.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriocalibracao.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriocalibracao.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatoriocalibracao.gerarExcel()"
                :disabled="$store.relatoriocalibracao.loading"
                ...
                <span x-show="$store.relatoriocalibracao.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriocalibracao.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriocalibracao.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
