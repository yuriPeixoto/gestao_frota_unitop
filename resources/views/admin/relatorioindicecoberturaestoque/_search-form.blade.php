<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatorioindicecoberturaestoque.gerarPdf()"
                :disabled="$store.relatorioindicecoberturaestoque.loading"
                ...
                <span x-show="$store.relatorioindicecoberturaestoque.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatorioindicecoberturaestoque.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioindicecoberturaestoque.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatorioindicecoberturaestoque.gerarExcel()"
                :disabled="$store.relatorioindicecoberturaestoque.loading"
                ...
                <x-icons.magnifying-glass x-show="!$store.relatorioindicecoberturaestoque.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioindicecoberturaestoque.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
