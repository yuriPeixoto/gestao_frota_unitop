    ...
    document.addEventListener('alpine:init', () => {
        Alpine.store('utils', {
            ...
            extratoabastecimentoterceiros() {
                ...
                fetch(`/admin/extratoabastecimentoterceiros/imprimir`, {
                    method: 'POST',
                    headers: {
            ...
            extratoabastecimentoterceirosExcel() {
                // Inicia o loading
                this.loading = true;
                ...
                fetch(`/admin/extratoabastecimentoterceiros/imprimirexcel`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
