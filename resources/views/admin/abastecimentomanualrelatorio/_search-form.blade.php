<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
            <x-forms.smart-select name="id_categoria" label="Categoria" placeholder="Selecione a categoria..."
                :options="$categoriaVeiculo" :asyncSearch="false" />
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div>
            <x-forms.smart-select name="id_combustivel" label="Tipo de Combustível" placeholder="Selecione o tipo de combustível..."
        ...
        <div>
            <x-forms.smart-select name="tipo_abastecimento" label="Tipo Abastecimento" :options="[
                ['value' => 'TRUCKPAG', 'label' => 'TRUCKPAG'],
                ['value' => 'ATS', 'label' => 'ATS'],
                ['value' => 'MANUAL', 'label' => 'MANUAL'],
            ]" :selected="request('tipo_abastecimento') ?? ''" />
        </div>
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" 
                x-on:click="$store.utils.imprimirAbastecimentoManual()"
            ...
            <button type="button" 
                x-on:click="$store.utils.imprimirAbastecimentoManualExcel()"
                :disabled="$store.utils.loading"
