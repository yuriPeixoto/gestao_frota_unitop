                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo tipo de veículo. Preencha o campo de
                                    descrição e clique em 'Salvar' para adicionar o novo tipo ou 'Cancelar' para
                                    retornar à lista de tipos.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">--}}
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('admin.tipoveiculos.store') }}" method="POST">
                        @csrf
