<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Edição de
                                    Tipo de Equipamento</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar um tipo de equipamento existente. Altere os campos
    ...
    @include('admin.tipoequipamentos._form', [
        'action' => route('admin.tipoequipamentos.update', $tipoequipamentos->id_tipo_equipamento),
        'method' => 'PUT',
