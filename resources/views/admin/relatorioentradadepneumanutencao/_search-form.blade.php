<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <x-forms.smart-select name="id_controle_vida_pneu" label="Vida Pneu:" placeholder="Selecionar"
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatorioentradadepneumanutencao.gerarPdf()"
                :disabled="$store.relatorioentradadepneumanutencao.loading"
                ...
                <span x-show="$store.relatorioentradadepneumanutencao.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatorioentradadepneumanutencao.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioentradadepneumanutencao.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatorioentradadepneumanutencao.gerarExcel()"
                :disabled="$store.relatorioentradadepneumanutencao.loading"
                ...
                <x-icons.magnifying-glass x-show="!$store.relatorioentradadepneumanutencao.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioentradadepneumanutencao.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
