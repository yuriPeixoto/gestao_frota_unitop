...
@php
    ...
    $currentClass = $classes[$currentType] ?? $classes['info'];
    $currentIcon = $icons[$currentType] ?? $icons['info'];
@endphp
...
<div x-data="{ show: true }"
     ...
     class="rounded-lg border p-4 {{ $currentClass }} shadow-sm">
    <div class="flex">
        @if($showIcon)
            ...
            <div class="ml-auto pl-3">
                <div class="-mx-1.5 -my-1.5">
                    <button @click="show = false" type="button"
                            class="inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 {{ str_replace('text', 'hover:bg', $currentClass) }}"
                            aria-label="Fechar">
