<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar um abastecimento manual existente. Altere os campos
    ...
    @include('admin.abastecimentomanual._form', [
        'action' => route('admin.abastecimentomanual.update', $abastecimento->id_abastecimento),
        'method' => 'PUT',
