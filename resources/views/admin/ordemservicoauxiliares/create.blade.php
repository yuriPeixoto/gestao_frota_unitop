<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Gerar O.S. Preventiva para Manutenção Auxiliares') }}
            </h2>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Cadastro de
                                    Abastecimento Manual</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo abastecimento manual. Preencha todos os
    ...
    @include('admin.ordemservicoauxiliares._form', [
        'action' => route('admin.ordemservicoauxiliares.store'),
        'method' => 'POST',
    ])
</x-app-layout>
