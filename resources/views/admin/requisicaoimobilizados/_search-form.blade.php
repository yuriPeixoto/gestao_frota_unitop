<form method="GET" action="{{ route('admin.requisicaoimobilizados.index') }}" class="space-y-4"
    hx-get="{{ route('admin.requisicaoimobilizados.index') }}" hx-target="#results-table" hx-select="#results-table"
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
            ...
            <x-forms.input name="id_relacao_imobilizados" label="Cód. Descarte Imobilizados"
