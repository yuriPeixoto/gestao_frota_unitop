<form method="GET" action="{{ route('admin.tipopessoal.index') }}" class="space-y-4"
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
        <div>
            <x-forms.input name="id" label="Código Tipo Solicitação" value="{{ request('id') }}" />
        </div>
    ...
    <div class="flex justify-between mt-4">
        <div>
            <div class="flex space-x-2">
                ...
                <x-forms.button type="secondary" href="{{ route('admin.tiposolicitacao.index') }}" variant="outlined">
