<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo IPVA para um veículo. Preencha os campos obrigatórios
                                    e adicione as parcelas de pagamento. O sistema permitirá que você gere parcelas automaticamente
                                    após salvar o registro inicial.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    @include('admin.ipvaveiculos._form', [
        'action' => route('admin.ipvaveiculos.store'),
        'method' => 'POST',
        'veiculos' => $veiculos ?? []
    ])
</x-app-layout>