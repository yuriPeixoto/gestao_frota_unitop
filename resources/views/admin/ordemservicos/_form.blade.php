...
text-gray-500
                    ...
                    <div class="mx-auto">
                        ...
                        <div class="flex space-x-1">
                            ...
                            @if (!isset($marcacoes) || $marcacoes->isEmpty())
                                <button type="button"
                                    class="tablink flex-1 py-2 px-4 bg-gray-200 text-gray-700 rounded-t-lg hover:bg-blue-400 hover:text-white transition-colors"
                            ...
                            @if (isset($ordem) && $ordem->id_tipo_ordem_servico == 3 && !$marcacoes->isEmpty())
                                <button type="button"
                                    class="tablink flex-1 py-2 px-4 bg-gray-200 text-gray-700 rounded-t-lg hover:bg-blue-400 hover:text-white transition-colors"
                                    onclick="openTab(event, 'Aba6')">
...
@push('scripts')
    <script src="{{ asset('js/manutencao/ordemservico/servicos.js') }}?v={{ time() }}"></script>
