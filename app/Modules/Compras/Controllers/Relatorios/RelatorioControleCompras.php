...
class RelatorioControleCompras extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.relatoriocontrolecompras.index', compact('filial', 'departamento'));
    }
    ...
    public function gerarPdf(Request $request)
    {
        try {
            ...
            //     Log::warning('Datas não informadas para geração do relatório.');
            ...
            if ($request->filled(['data_inclusao', 'data_final'])) {
                ...
                $name       = 'relatorio_compras_detalhado';
