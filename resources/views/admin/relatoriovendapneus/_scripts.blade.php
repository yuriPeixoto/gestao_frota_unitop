<script>
    document.addEventListener('alpine:init', () => {
        Alpine.store('relatoriovendapneus', {
            loading: false,
            ...
            async gerarPdf() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriovendapneus/gerarpdf', dados);
                    const blob = await response.blob();

                    this.fazerDownload(blob, `vendaPneu_v3${new Date().toISOString().slice(0,10)}.pdf`);
            ...
            async gerarExcel() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriovendapneus/gerarexcel', dados);
                    const blob = await response.blob();
