<script>
    ...
    function popularHistoricoTabela() {
        ...
        function preencherCamposEdicao(index) {
            ...
            document.querySelector('[name="id_reponsavel"]').value = item.id_pessoal || '';
            ...
            // Campo input normal: id_produtos
            const descricao = produtoDescricao[item.id_produtos] ?? '';
            document.querySelector('[name="id_produtos"]').value = `${item.id_produtos} - ${descricao}`;
        }
        ...
        function preencherTabelaTermo(requisicaoItensFiltrados){
            ...
            document.queryDocumentById('arquivo').value = item.arquivo || '';
        }
    }
    ...
    function preencherCamposEdicao(index) {
        ...
        const setValue = (name, value) => {
            ...
            else console.warn(`Campo não encontrado: ${name}`);
        };

        // Aqui só usa os campos que realmente existem
        setValue("id_produtos_imobilizados", item.id_produtos_imobilizados);
        setValue("id_reponsavel", item.id_reponsavel);
        setValue("id_lider", item.id_lider);
        setValue("id_departamento", item.id_departamento);
        setValue("id_veiculo", item.id_veiculo);
    }
