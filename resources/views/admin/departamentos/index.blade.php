<x-app-layout>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative inline-block text-left" x-data="{ helpOpen: false }">
                    ...
                    <div x-show="helpOpen" @click.away="helpOpen = false"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Departamentos
                                </p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode visualizar todos os departamentos cadastrados.
                                    Utilize o botão 'Novo Departamento' para adicionar um novo registro.
                                    Você pode editar ou excluir departamentos utilizando as
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <!-- Search Form -->
                @include('admin.departamentos._search-form')

                <!-- Results Table -->
                <div class="mt-6 overflow-x-auto relative min-h-[400px]">


                    @include('admin.departamentos._table')
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Tem certeza que deseja excluir o departamento <span id="depto-descricao"
    ...
    <script>
        ...
        const descricaoSpan = document.getElementById('depto-descricao');
        const spinner = document.getElementById('spinner-exclusao');
        
        // Função para editar departamento
        function editarDepartamento(id) {
            window.location.href = `{{ route('admin.departamentos.edit', ':id') }}`.replace(':id', id);
        }
        ...
        function executarExclusao() {
            ...
            fetch(`{{ route('admin.departamentos.destroy', ':id') }}`.replace(':id', idExclusao), {
                method: 'DELETE',
                headers: {
            ...
            .then(data => {
                ...
                showNotification(
                    ...
                    data.notification ? data.notification.message : 'Departamento excluído com sucesso',
            ...
            .catch(error => {
                ...
                showNotification(
                    'Erro',
                    error.message || 'Não foi possível excluir o departamento',
                    'error'
                );
            })
            .finally(() => {
