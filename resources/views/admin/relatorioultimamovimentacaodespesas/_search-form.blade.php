<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatorioultimamovimentacaodespesas.gerarPdf()"
                :disabled="$store.relatorioultimamovimentacaodespesas.loading"
                ...
                <span x-show="$store.relatorioultimamovimentacaodespesas.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatorioultimamovimentacaodespesas.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioultimamovimentacaodespesas.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatorioultimamovimentacaodespesas.gerarExcel()"
                :disabled="$store.relatorioultimamovimentacaodespesas.loading"
                ...
                <x-icons.magnifying-glass x-show="!$store.relatorioultimamovimentacaodespesas.loading"
                    class="h-4 w-4 mr-2" />
                <span
                    x-text="$store.relatorioultimamovimentacaodespesas.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
