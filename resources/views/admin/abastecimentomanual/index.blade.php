...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Abastecimento Manual') }}
            </h2>
            <div class="flex items-center space-x-4">
                {{-- Botão Criar - Protegido por Permissão --}}
                @can('criar_abastecimentomanual')
                <a href="{{ route('admin.abastecimentomanual.create') }}"
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="p-6 bg-white border-b border-gray-200">
                <!-- Search Form -->
                @include('admin.abastecimentomanual._search-form')
                ...
                <div class="mt-6 overflow-x-auto relative min-h-[400px]">
                    ...
                    <div id="results-table" class="opacity-0 transition-opacity duration-300">
                        @include('admin.abastecimentomanual._table')
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('scripts')
    @include('admin.abastecimentomanual._scripts')
