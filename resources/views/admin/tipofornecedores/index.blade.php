<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            ...
            <div class="flex items-center space-x-4">
                <x-button-link href="{{ route('admin.tipofornecedores.create') }}"
                ...
                <div class="relative inline-block text-left" x-data="{ helpOpen: false }">
                    ...
                    <div x-show="helpOpen" @click.away="helpOpen = false"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Tipo Fornecedor
                                </p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode visualizar todos os tipos de fornecedor cadastrados. Utilize o
                                    botão 'Cadastrar Tipo' para adicionar um novo registro. Você pode editar ou excluir
                                    tipos de fornecedor utilizando as ações disponíveis em cada linha da tabela.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            ...
            <!-- Search Form -->
            @include('admin.tipofornecedores._search-form')
                ...
                <div id="results-table">
                    <x-tables.table>
                        ...
                        <x-tables.body>
                            ...
                            <x-tables.row :index="$index" data-id="{{ $fornecedor->id_tipo_fornecedor }}">
                                ...
                                <x-tables.cell>
                                    <div class="flex items-center space-x-2">
                                        <button type="button"
                                            onclick="editarTipoFornecedor({{ $fornecedor->id_tipo_fornecedor }})"
                                        ...
                                        <button type="button"
                                            onclick="confirmarExclusao({{ $fornecedor->id_tipo_fornecedor }}, '{{ $fornecedor->descricao_tipo }}')"
                            ...
                            @empty
                            <x-tables.empty cols="5" message="Nenhum tipo de fornecedor encontrado" />
                            @endforelse
                        </x-tables.body>
                    </x-tables.table>
    ...
    <script>
        ...
        // Função para editar tipo de fornecedor
        function editarTipoFornecedor(id) {
            window.location.href = `{{ route('admin.tipofornecedores.edit', ':id') }}`.replace(':id', id);
        }
        ...
        function executarExclusao() {
            ...
            fetch(`{{ route('admin.tipofornecedores.destroy', ':id') }}`.replace(':id', idExclusao), {
                method: 'DELETE',
                headers: {
            ...
            .catch(error => {
                ...
                showNotification(
                    'Erro',
                    error.message || 'Não foi possível excluir o tipo de fornecedor',
                    'error'
                );
            })
            .finally(() => {
