    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Editar Tipo Imobilizado') }}: {{ $tipoimobilizados->descricao_tipo_imobilizados }}
            </h2>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar as informações de um tipo de imobilizado existente.
        ...
        <div>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.tipoimobilizados.update', $tipoimobilizados) }}" method="POST">
                        @csrf
                        @method('PUT')
