    ...
    document.addEventListener('alpine:init', () => {
        Alpine.store('utils', {
            ...
            faturamentoabastecimento() {
                ...
                fetch(`/admin/faturamentoabastecimento/imprimir`, {
                    method: 'POST',
                    headers: {
                ...
                .then(blob => {
                    ...
                    this._downloadFile(blob, `abastecimento_terceiros_${new Date().toISOString().split('T')[0]}.pdf`);
            ...
            faturamentoabastecimentoExcel() {
                ...
                fetch(`/admin/faturamentoabastecimento/imprimirexcel`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                ...
                .then(blob => {
                    this._removeLoadingMessage();
                    this._downloadFile(blob, `relatorio_abastecimento_${new Date().toISOString().split('T')[0]}.xls`);
                    console.log('Download iniciado com sucesso');
                })
