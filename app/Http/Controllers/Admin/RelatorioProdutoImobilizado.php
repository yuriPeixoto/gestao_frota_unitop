...
class RelatorioProdutoImobilizado extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.relatorioprodutoimobilizado.index', compact('filial', 'produto'));
    }
