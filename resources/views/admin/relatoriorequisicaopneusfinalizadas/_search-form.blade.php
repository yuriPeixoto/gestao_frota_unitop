<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <x-forms.smart-select name="id_requisicao_pneu" label="Cód. Requisição:" placeholder="Selecionar"
            :options="$requisicao" value="{{ request('id_requisicao_pneu') }}" />
        <!-- Filial -->
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatoriorequisicaopneusfinalizadas.gerarPdf()"
                :disabled="$store.relatoriorequisicaopneusfinalizadas.loading"
                ...
                <span x-show="$store.relatoriorequisicaopneusfinalizadas.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriorequisicaopneusfinalizadas.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriorequisicaopneusfinalizadas.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatoriorequisicaopneusfinalizadas.gerarExcel()"
                :disabled="$store.relatoriorequisicaopneusfinalizadas.loading"
                ...
                <x-icons.magnifying-glass x-show="!$store.relatoriorequisicaopneusfinalizadas.loading"
                    class="h-4 w-4 mr-2" />
                <span
                    x-text="$store.relatoriorequisicaopneusfinalizadas.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
