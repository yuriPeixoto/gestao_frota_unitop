<form method="GET" action="{{ route('admin.controlelicencavencimentario.index') }}" class="space-y-4"
    hx-get="{{ route('admin.controlelicencavencimentario.index') }}" hx-target="#results-table" hx-select="#results-table"
    ...
    <div class="flex justify-between mt-4">
        <div>
            <x-ui.export-buttons route="admin.controlelicencavencimentario" :formats="['pdf', 'csv', 'xls', 'xml']" />
        </div>
