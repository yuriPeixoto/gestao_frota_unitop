<script>
    document.addEventListener('alpine:init', () => {
        Alpine.store('relatoriocalibracao', {
            loading: false,
            ...
            async gerarPdf() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriocalibracao/gerarpdf', dados);
            ...
            async gerarExcel() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriocalibracao/gerarexcel', dados);
                    const blob = await response.blob();
