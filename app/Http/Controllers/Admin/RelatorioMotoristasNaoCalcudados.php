...
class RelatorioMotoristasNaoCalcudados extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.relatoriomotoristanaocalculado.index', compact('datainicial', 'datafinal'));
    }
    ...
    public function gerarpdf(Request $request)
    {
        ...
        if (!empty($request['data_inclusao']) && !empty($request['data_final'])) {
            ...
            $name  = 'relatorio_motorista_nao_premio';
    ...
    public function gerarExcel(Request $request)
    {
        if (!empty($request['data_inclusao']) && !empty($request['data_final'])) {
            ...
            $name  = 'relatorio_motorista_nao_premio2';
