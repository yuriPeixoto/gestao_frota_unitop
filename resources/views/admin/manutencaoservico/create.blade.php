<x-app-layout>
            ...
            <div class="flex items-center space-x-4">
                <div class="relative inline-block text-left" x-data="{ helpOpen: false }">
                    ...
                    <div x-show="helpOpen" @click.away="helpOpen = false"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Planejamento Manutenção por Categoria</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo Planejamento Manutenção por Categoria. Preencha todos os
                                    campos obrigatórios.
                                </p>
                            </div>
                        </div>
    ...
    @include('admin.manutencaoservico._form', [
        'action' => route('admin.manutencaoservico.store'),
        'method' => 'POST',
    ])
</x-app-layout>
