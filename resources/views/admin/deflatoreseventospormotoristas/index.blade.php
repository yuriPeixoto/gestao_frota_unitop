    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Eventos Deflatores por Motoristas') }}
            </h2>
            <div class="flex items-center space-x-4">
                <a href="{{ route('admin.deflatoreseventospormotoristas.create')}}"
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="p-6 bg-white border-b border-gray-200">
                <!-- Search Form -->
                @include('admin.deflatoreseventospormotoristas._search-form')

                <!-- Results Table -->
                <div class="mt-6 overflow-x-auto" id="results-table">
                    <div class="mt-6 overflow-x-auto">
                        @include('admin.deflatoreseventospormotoristas._table')
                    </div>
                </div>
            </div>
        </div>
