<script>
    document.addEventListener('alpine:init', () => {
        Alpine.store('relatoriocontratofornecedores', {
            loading: false,
            ...
            async gerarPdf() {
                ...
                //    if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriocontratofornecedores/gerarpdf', dados);
            ...
            async gerarExcel() {
                ...
                //    if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriocontratofornecedores/gerarexcel', dados);
                    const blob = await response.blob();
