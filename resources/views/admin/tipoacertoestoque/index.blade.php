<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">
                                    Ajuda - Tipo Acerto Estoque
                                </p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Esta tela exibe os registros de Tipo Acerto Estoque. Use os filtros abaixo para
                                    refinar sua busca.
                                </p>
                            </div>
                        </div>
    ...
    @include('admin.tipoacertoestoque.create')
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                @include('admin.tipoacertoestoque._search-form')
                <div class="mt-6 overflow-x-auto" id="results-table">
                    <div class="mt-6 overflow-x-auto">
                        @include('admin.tipoacertoestoque._table')
                    </div>
                </div>
            </div>
        </div>
...
@include('admin.tipoacertoestoque._script')
