<div class="results-table">
    <x-tables.table>
        <x-tables.header>
            <x-tables.head-cell>Cód.<br>Recebimento<br>Imobilizado</x-tables.head-cell>
            <x-tables.head-cell>Recebimento</x-tables.head-cell>
            <x-tables.head-cell>Motivo Recibimento</x-tables.head-cell>
        ...
        <x-tables.body>
            ...
            <x-tables.row :index="$index">
                <x-tables.cell>{{ $relacaoImobilizado->id_recebimento_imobilizado }}</x-tables.cell>
                <x-tables.cell>{{ $relacaoImobilizado->is_recebido ? 'Sim' : 'Não' }}</x-tables.cell>
                <x-tables.cell>{{ $relacaoImobilizado->motivo_recebimento }}</x-tables.cell>
