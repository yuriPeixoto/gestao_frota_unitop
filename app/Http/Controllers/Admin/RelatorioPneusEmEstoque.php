...
class RelatorioPneusEmEstoque extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.relatoriopneusestoque.index', [
            'filiais' => $filiais,
            'vidaPneu' => $vidaPneu,
            'modelo'    => $modelo,
            'pneu'  => $pneu
    ...
    public function gerarPdf(Request $request)
    {
        ...
        $id_controle_vida_pneu          = empty($request['id_controle_vida_pneu']) ? "0" : $request['id_controle_vida_pneu'];
