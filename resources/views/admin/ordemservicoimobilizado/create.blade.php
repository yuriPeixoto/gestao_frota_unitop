<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Cadastrar Ordem de serviço Imobilizados') }}
            </h2>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Cadastro de
                                    Produtos Imobilizados</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo produtos imobilizados. Preencha todos os
    ...
    'action' => route('admin.ordemservicoimobilizado.store'),
    'method' => 'POST',
    ])
</x-app-layout>