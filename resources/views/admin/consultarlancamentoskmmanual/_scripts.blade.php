...
document.addEventListener('alpine:init', () => {
    Alpine.store('utils', {
        ...
        imprimirLancamentosKm() {
            ...
            fetch(`/admin/consultarlancamentoskmmanual/imprimir`, {
                method: 'POST',
                headers: {
            ...
            .then(blob => {
                ...
                const filename = `abastecimento_lanc_km_manual_${new Date().toISOString().split('T')[0]}.pdf`;
        ...
        imprimirLancamentosKmExcel() {
            ...
            fetch(`/admin/consultarlancamentoskmmanual/imprimirexcel`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
            ...
            .then(blob => {
                ...
                const filename = `relatorio_abastecimento_${new Date().toISOString().split('T')[0]}.xls`;
                this.downloadFile(blob, filename);
