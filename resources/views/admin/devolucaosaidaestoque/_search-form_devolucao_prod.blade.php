<form method="GET" action="{{ route('admin.devolucaosaidaestoque.index') }}" class="space-y-4"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
            <x-forms.input name="id_devolucao_produtos" label="Código Devolução"
                value="{{ request('id_devolucao_produtos') }}" />
        </div>

        <div>
            <x-forms.input name="id_ordem_servico" label="Código Ordem de Serviço"
    ...
    <div class="flex justify-between mt-4">
        ...
        <div>
            <x-forms.button href="{{ route('admin.devolucaosaidaestoque.create_devProdutos') }}">
