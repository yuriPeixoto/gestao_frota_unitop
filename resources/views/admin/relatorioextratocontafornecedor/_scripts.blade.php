<script>
    document.addEventListener('alpine:init', () => {
        Alpine.store('relatorioextratocontafornecedor', {
            loading: false,
            ...
            async gerarPdf() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatorioextratocontafornecedor/gerarpdf', dados);
            ...
            async gerarExcel() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatorioextratocontafornecedor/gerarexcel', dados);
                    const blob = await response.blob();
