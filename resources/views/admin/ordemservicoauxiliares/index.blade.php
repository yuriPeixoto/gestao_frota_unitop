<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Listagem O.S Preventiva Auxiliares') }}
            </h2>
            <div class="flex items-center space-x-4">
                ...
                @endif
                <a href="{{ route('admin.ordemservicoauxiliares.create') }}"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">
                                    Ajuda - O.S Preventiva Auxiliares
                                </p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Está tela tem como finalidade exibir os registros de O.S Preventiva Auxiliares. Os
                                    campos abaixo servem para realizar buscas nos registros lançados!
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="p-6 bg-white border-b border-gray-200">
                <!-- Search Form -->
                @include('admin.ordemservicoauxiliares._search-form')

                <!-- Results Table -->
                <div class="mt-6 overflow-x-auto" id="results-table">

                    <div class="mt-6 overflow-x-auto">
                        @include('admin.ordemservicoauxiliares._table')
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('scripts')
    @include('admin.ordemservicoauxiliares._visualizar-os')
