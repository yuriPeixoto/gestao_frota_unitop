<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            <x-forms.smart-select name="id_tipo_equipamento" label="Tipo de Equipamento" placeholder="Selecione o tipo de equipamento..."
                :options="$tiposEquipamento" asyncSearch="false" />
        </div>
    </div>
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" 
                x-on:click="$store.utils.imprimirAbastecimentoEquipamento()"
            ...
            <button type="button" 
                x-on:click="$store.utils.imprimirAbastecimentoEquipamentoExcel()"
                :disabled="$store.utils.loading"
