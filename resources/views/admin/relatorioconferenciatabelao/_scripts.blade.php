<script>
    document.addEventListener('alpine:init', () => {
        Alpine.store('relatorioconferenciatabelao', {
            loading: false,
            ...
            async gerarPdf() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatorioconferenciatabelao/gerarpdf', dados);
            ...
            async gerarExcel() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatorioconferenciatabelao/gerarexcel', dados);
                    const blob = await response.blob();
