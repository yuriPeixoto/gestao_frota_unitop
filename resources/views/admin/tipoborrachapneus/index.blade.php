<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Está tela tem como finalidade exibir os registros de tipo de borracha pneus. Os
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="p-6 bg-white border-b border-gray-200">
                <!-- Search Form -->
                @include('admin.tipoborrachapneus._search-form')

                <!-- Results Table -->
                <div class="mt-6 overflow-x-auto" id="results-table">

                    <div class="mt-6 overflow-x-auto">
                        @include('admin.tipoborrachapneus._table')
                    </div>
                </div>
            </div>
        </div>
    ...
    @include('admin.tipoborrachapneus.create')
</x-app-layout>