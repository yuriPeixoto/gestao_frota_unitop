<form method="GET" action="{{ route('admin.devolucoes.index') }}" class="space-y-4"
    ...
    <input type="hidden" name="active_tab" id="active_tab_unificado" value="Aba1">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
            <x-forms.input name="id_transferencia_direta_estoque" label="Código Transferência Direta"
        ...
        <div>
            <x-forms.input name="status" label="Status" value="{{ request('status') }}" />
        </div>
    </div>
