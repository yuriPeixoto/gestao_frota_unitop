<div class="space-y-6 bg-white">
    ...
    @php
    $isCreate = Route::currentRouteName() == 'admin.pneusdeposito.create' ? true : false;
    @endphp
    ...
    <x-bladewind::tab-group name="tab-icon">
        ...
        <x-bladewind::tab-body>
            <x-bladewind::tab-content name="dados_pneus" active="true">
                @include('admin.pneusdeposito._cadastros')
    ...
    <div class="flex justify-end space-x-3 col-span-full">
        ...
        <button type="submit" id="submit-form"
            ...
            {{ isset($calibragem) ? 'Atualizar' : 'Salvar' }}
        </button>
    </div>
</div>