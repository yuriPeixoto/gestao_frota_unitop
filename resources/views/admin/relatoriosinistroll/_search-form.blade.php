<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatoriosinistroll.gerarPdf()"
                :disabled="$store.relatoriosinistroll.loading"
                ...
                <span x-show="$store.relatoriosinistroll.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriosinistroll.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriosinistroll.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            {{-- <button type="button" x-on:click="$store.relatoriosinistroll.gerarPdfTotalizado()"
                :disabled="$store.relatoriosinistroll.loading"
                ...
                <span x-show="$store.relatoriosinistroll.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriosinistroll.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriosinistroll.loading ? 'Gerando...' : 'Buscar Totalizado'"></span>
            </button> --}}

            <button type="button" x-on:click="$store.relatoriosinistroll.gerarExcel()"
                :disabled="$store.relatoriosinistroll.loading"
                ...
                <span x-show="$store.relatoriosinistroll.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriosinistroll.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriosinistroll.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
