<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatoriochecklistfornecedor.gerarPdf()"
                :disabled="$store.relatoriochecklistfornecedor.loading"
                ...
                <span x-show="$store.relatoriochecklistfornecedor.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriochecklistfornecedor.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriochecklistfornecedor.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatoriochecklistfornecedor.gerarExcel()"
                :disabled="$store.relatoriochecklistfornecedor.loading"
                ...
                <span x-show="$store.relatoriochecklistfornecedor.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriochecklistfornecedor.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriochecklistfornecedor.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
