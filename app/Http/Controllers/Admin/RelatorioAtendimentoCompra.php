...
class RelatorioAtendimentoCompra extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.relatorioatendimentocompra.index', compact('filial'));
    }
    ...
    public function gerarPdf(Request $request)
    {
        try {
            ...
            if ($request->filled(['data_inclusao', 'data_final'])) {
                ...
                $name       = 'relatorio_atendimento_solicitacoes_compras';
    ...
    public function gerarExcel(Request $request)
    {
        try {
            ...
            if ($request->filled(['data_inclusao', 'data_final'])) {
                ...
                $name       = 'relatorio_atendimento_solicitacoes_compras_v2';
                $agora = now()->format('d-m-Y_H-i');
