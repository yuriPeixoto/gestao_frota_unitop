<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatoriohistoricokm.gerarPdf()"
                :disabled="$store.relatoriohistoricokm.loading"
                ...
                <span x-show="$store.relatoriohistoricokm.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriohistoricokm.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriohistoricokm.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatoriohistoricokm.gerarExcel()"
                :disabled="$store.relatoriohistoricokm.loading"
                ...
                <span x-show="$store.relatoriohistoricokm.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriohistoricokm.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriohistoricokm.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
