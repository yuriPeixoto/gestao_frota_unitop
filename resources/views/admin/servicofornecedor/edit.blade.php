<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Edição de
                                    Serviço X Prestador</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar um Serviço X Prestador existente. Altere os campos
    ...
    @include('admin.servicofornecedor._form', [
        'action' => route('admin.servicofornecedor.update', $manutencaoConfig->id_precoservicoxfornecedor),
        'method' => 'PUT',
