<script>
    document.addEventListener('alpine:init', () => {
        Alpine.store('relatoriovaloresexcedentes', {
            loading: false,
            ...
            async gerarPdf() {
                ...
                //    if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriovaloresexcedentes/gerarpdf', dados);
            ...
            async gerarExcel() {
                ...
                //    if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriovaloresexcedentes/gerarexcel', dados);
                    const blob = await response.blob();
