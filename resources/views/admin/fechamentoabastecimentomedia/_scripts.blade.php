    ...
    document.addEventListener('alpine:init', () => {
        Alpine.store('utils', {
            ...
            fechamentoabastecimentomedia() {
                ...
                fetch(`/admin/fechamentoabastecimentomedia/imprimir`, {
                    method: 'POST',
                    headers: {
                ...
                .then(blob => {
                    ...
                    this._downloadFile(blob, `fechamentoabastecimentomedia_${new Date().toISOString().split('T')[0]}.pdf`);
            ...
            fechamentoabastecimentomediaExcel() {
                // Inicia o loading
                this.loading = true;
                ...
                fetch(`/admin/fechamentoabastecimentomedia/imprimirexcel`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                ...
                .then(blob => {
                    this._removeLoadingMessage();
                    this._downloadFile(blob, `fechamentoabastecimentomedia_${new Date().toISOString().split('T')[0]}.xls`);
                    console.log('Download iniciado com sucesso');
                })
