            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="relative inline-block text-left" x-data="{ helpOpen: false }">
                    ...
                    <div x-show="helpOpen" @click.away="helpOpen = false"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Criação de
                                    Departamento</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo departamento. Preencha todos os campos
                                    obrigatórios com as informações do departamento. Após o preenchimento, clique em
                                    'Salvar' para adicionar o novo registro ou 'Cancelar' para retornar à lista de
                                    departamentos.
                                </p>
                            </div>
                        </div>
