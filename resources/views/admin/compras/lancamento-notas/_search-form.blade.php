<form method="GET" action=" {{ route('admin.compras.lancamento-notas.index')}}" class="space-y-4">
    ...
    <div class="flex w-full gap-3">
        ...
        <div class="w-full">
            <x-forms.smart-select name="placa" label="Placa" :options="$placas"
    ...
    <div class="flex w-full gap-3">
        ...
        <div class="w-full">
            <x-forms.smart-select name="nome_fornecedor" label="Fornecedor" :options="$fornecedores"
        ...
        <div class="w-full">
            <x-forms.smart-select name="id_ordem_servico" label="N° O.S" :options="$ordemServico"
                :searchUrl="route('admin.api.ordemservico.search')" asyncSearch="true" />
        </div>
    </div>
    ...
    <div>
        ...
        <a href="{{ route('admin.compras.lancamento-notas.exportPdf', request()->only(['id_pedido_compras', 'data_inclusao', 'data_final'])) }}"
            data-type="PDF" class=" inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded
        ...
        {{-- Usar o novo componente de botões de exportação --}}
        <a href="{{ route('admin.compras.lancamento-notas.exportCsv', request()->only(['id_pedido_compras', 'data_inclusao', 'data_final'])) }}"
            data-type="CVS"
        ...
        {{-- Usar o novo componente de botões de exportação --}}
        <a href="{{ route('admin.compras.lancamento-notas.exportXls', request()->only(['id_pedido_compras', 'data_inclusao', 'data_final'])) }}"
            data-type="XLS"
            class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 export-btn">
        ...
        {{-- Usar o novo componente de botões de exportação --}}
        <a href="{{ route('admin.compras.lancamento-notas.exportXml', request()->only(['id_pedido_compras', 'data_inclusao', 'data_final'])) }}"
            data-type="XML"
            class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 export-btn">
