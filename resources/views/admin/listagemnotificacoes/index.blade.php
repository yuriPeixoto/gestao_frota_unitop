...
<x-app-layout>
    ...
    <div class="bg-white  shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="p-8 bg-white border-b border-gray-200">
                ...
                <!-- Search Form -->
                @include('admin.listagemnotificacoes._search-form')
                ...
                <div class="mt-6 relative min-h-[400px]">
                    ...
                    <div id="results-table" class="opacity-0 transition-opacity duration-300">
                        @include('admin.listagemnotificacoes._table')
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('scripts')
    @include('admin.listagemnotificacoes._scripts')
