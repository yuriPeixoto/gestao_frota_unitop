<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatorioorigembaixas.gerarPdf()"
                :disabled="$store.relatorioorigembaixas.loading"
                ...
                <span x-show="$store.relatorioorigembaixas.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatorioorigembaixas.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioorigembaixas.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatorioorigembaixas.gerarExcel()"
                :disabled="$store.relatorioorigembaixas.loading"
                ...
                <span x-show="$store.relatorioorigembaixas.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatorioorigembaixas.loading" class="h-4 w-4 mr-2" />
                <span x-text="$store.relatorioorigembaixas.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
