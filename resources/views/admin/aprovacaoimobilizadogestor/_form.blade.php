            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                    ...
                    <div>
                        ...
                        <label for="observacao_gestor" class="block text-sm font-medium text-gray-700"> Observação
                            do gestor</label>

                        <textarea id="observacao_gestor" name="observacao_gestor"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    {{ old('observacao_gestor', $relacaoImobilizados->observacao_gestor ?? '') }}
                                </textarea>
                    </div>
