            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <x-forms.smart-select name="situacao_sinistro_processo" label="status" :options="[
                            ['value' => 'Finalizada', 'label' => 'Finalizada'],
                            ['value' => 'Em Andamento', 'label' => 'Em Andamento'],
                        ]" asyncSearch="false" :selected="request('situacao_sinistro_processo') ?? ''" />
                        ...
                        @endphp
                        <x-forms.smart-select name="setor" label="Setor" placeholder="Selecione o setor..."
                            :options="$processolist" asyncSearch="false" />
                    </div>
                    ...
                    <div class="flex justify-between mt-4">
                        <div class="flex space-x-2">
                            ...
                            <button type="button" x-on:click="$store.utils.imprimirSinistroTotalizador()"
                                :disabled="$store.utils.loading"
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed">
                                ...
                                <!-- Texto do botão -->
                                <span x-text="$store.utils.loading ? 'Gerando...' : 'Totalizado'"></span>
                            </button>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
                Alpine.store('utils', {
                    ...
                    _coletarDadosFormulario() {
                        return {
                            ...
                            setor: document.querySelector('select[name="setor"], #setor')?.value || '',
                        };
                    },
                ...
                `;
                    ...
                    async onGeneratePDF() {
                        ...
                        try {
                            ...
                            const response = await this._fazerRequisicao(
                                '/admin/relatorios/sinistro/onGeneratePdf', data);
                    ...
                    async imprimirSinistroTotalizador() {
                        this.loading = true;
                        ...
                        try {
                            ...
                            const response = await this._fazerRequisicao(
                                '/admin/relatorios/sinistro/onGenerateTotalizador', data);
                            ...
                            const blob = await response.blob();
                            this._fazerDownload(blob,
                                `relatorio_sinistro_totalizado_${new Date().toISOString().split('T')[0]}.pdf`
                            );
                    ...
                    async imprimirSinistroExcel() {
                        ...
                        try {
                            ...
                            const response = await this._fazerRequisicao(
                                '/admin/relatorios/sinistro/onGenerateXls', data);
