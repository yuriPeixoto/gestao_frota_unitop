<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatoriogastosfilialedepartamento.gerarPdf()"
                :disabled="$store.relatoriogastosfilialedepartamento.loading"
                ...
                <span x-show="$store.relatoriogastosfilialedepartamento.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriogastosfilialedepartamento.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriogastosfilialedepartamento.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatoriogastosfilialedepartamento.gerarExcel()"
                :disabled="$store.relatoriogastosfilialedepartamento.loading"
                ...
                <x-icons.magnifying-glass x-show="!$store.relatoriogastosfilialedepartamento.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriogastosfilialedepartamento.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
