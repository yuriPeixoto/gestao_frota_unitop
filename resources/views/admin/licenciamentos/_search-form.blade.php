<form method="GET" action="{{ route('admin.licenciamentos.index') }}" class="space-y-4"
    hx-get="{{ route('admin.licenciamentos.index') }}" hx-target="#results-table" hx-select="#results-table"
    ...
    <div class="flex justify-between mt-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
            <x-ui.export-buttons route="admin.licenciamentos" :formats="['pdf', 'csv', 'xls', 'xml']" />
