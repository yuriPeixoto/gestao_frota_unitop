            ...
            <x-tables.row :index="$index">
                ...
                <x-tables.cell>
                    <div class="flex items-center space-x-2">
                        <a href="{{ route('admin.requisicaoimobilizados.edit', $relacaoImobilizado->id_relacao_imobilizados) }}"
                        ...
                        <button type="button"
                            onclick="destroyOrdemServico({{ $relacaoImobilizado->id_relacao_imobilizados }})"
