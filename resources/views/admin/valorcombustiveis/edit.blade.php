<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Editar Valor de Combustível por Bomba') }}
            </h2>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar um valor de combustível existente. Modifique os
                                    campos necessários e clique em Atualizar para salvar as alterações.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    'action' => route('admin.valorcombustiveis.update', $valorCombustiveis->id_valor_combustivel_terceiro),
    'method' => 'PUT',
