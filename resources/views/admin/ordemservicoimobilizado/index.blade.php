    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Ordem de Serviço Imobilizados') }}
            </h2>
            <div class="flex items-center space-x-4">
                <a href="{{ route('admin.ordemservicoimobilizado.create') }}"
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <!-- Search Form -->
                @include('admin.ordemservicoimobilizado._search-form')
                ...
                <div class="mt-6 overflow-x-auto relative min-h-[400px]">
                    ...
                    <div id="results-table" class="opacity-0 transition-opacity duration-300">
                        @include('admin.ordemservicoimobilizado._table')
                    </div>
                </div>
            </div>
        </div>
