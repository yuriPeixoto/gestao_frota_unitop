<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Editar Notas Fiscais de Serviço (Rateio)') }}
            </h2>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Edição de
                                    Notas Fiscais de Serviço (Rateio)</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar uma nota fiscal existente. Altere os campos
    ...
    @include('admin.listagemoslacamentoservicorateio._form', [
        'action' => route('admin.listagemoslacamentoservicorateio.update', $cadastros->id_nota_fiscal_servico),
        'method' => 'PUT',
        'cadastros' => $cadastros,
    ])
</x-app-layout>
