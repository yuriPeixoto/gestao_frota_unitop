<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Cadastrar Teste de Opacidade') }}
            </h2>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Cadastro de
                                    Teste de Opacidade</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo teste de Opacidade. Preencha todos os campos
                                    obrigatórios
                                    e clique em Salvar para confirmar o cadastro.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div>
        <div class="mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('admin.testefumacas.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
