            ...
            <div class="bg-white p-6">
                ...
                <div class="mb-6 border-b border-gray-200 px-4 pt-4">
                    <nav class="flex space-x-8" aria-label="Abas">
                        <a href="{{ route('admin.compras.validarcotacoes.index', array_merge(request()->except(['tipo_solicitacao', 'page']), [])) }}"
                        ...
                        <a href="{{ route('admin.compras.validarcotacoes.index', array_merge(request()->except(['page']), ['tipo_solicitacao' => '1'])) }}"
                        ...
                        <a href="{{ route('admin.compras.validarcotacoes.index', array_merge(request()->except(['page']), ['tipo_solicitacao' => '2'])) }}"
                ...
                <!-- Search Form -->
                @include('admin.compras.validarcotacoes._search-form')

                <!-- Results Table with Loading -->
                <div class="relative mt-6 min-h-[400px] overflow-x-auto">

                    <!-- Actual results -->
                    @include('admin.compras.validarcotacoes._table')
                </div>
            </div>
        </div>
    </div>
