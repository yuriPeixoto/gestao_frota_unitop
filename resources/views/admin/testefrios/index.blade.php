<x-app-layout>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative inline-block text-left" x-data="{ helpOpen: false }">
                    ...
                    <div x-show="helpOpen" @click.away="helpOpen = false"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Teste de Frio
                                </p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Esta tela permite gerenciar os testes de frio dos veículos. Use o formulário de
                                    busca para filtrar
                                    por placa, data de vencimento ou número do certificado.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="mb-4">
                @include('admin.testefrios._search-form')
            </div>
            @include('admin.testefrios._table')
        </div>
    </div>
