<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Editar Planejamento Manutencão') }}
            </h2>
    ...
    @include('admin.manutencaoservico._form', [
        'action' => route('admin.manutencaoservico.update', $manutencaoConfig->id_planejamento_manutencao),
        'method' => 'PUT',
