<form method="GET" action="{{ route('admin.compras.validarcotacoes.index') }}" class="space-y-4"
    hx-get="{{ route('admin.compras.validarcotacoes.index') }}" hx-target="#results-table" hx-select="#results-table"
