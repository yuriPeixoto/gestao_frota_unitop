<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Editar Multa') }} #{{ $multas->id_motivo_multa }}
            </h2>
            <div class="flex items-center space-x-4">
                ...
                <div class="relative inline-block text-left" x-data="{ helpOpen: false }">
                    ...
                    <div x-show="helpOpen" @click.away="helpOpen = false"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Edição de Multa
                                </p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar uma multa existente. Altere os campos necessários e
    ...
    'action' => route('admin.multas.update', $multas->id_motivo_multa),
    'multas' => $multas
    ])
</x-app-layout>