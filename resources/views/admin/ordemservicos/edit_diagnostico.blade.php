<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Ordem de Serviço Diagnostico #') . (isset($ordemServico) ? $ordemServico->id_ordem_servico : '') }}
            </h2>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar uma ordem de serviço existente. Altere os campos
    ...
    @include('admin.ordemservicos._form_diagnostico', [
        'action' => route('admin.ordemservicos.update_diagnostico', $ordemServico->id_ordem_servico),
        'method' => 'PUT',
