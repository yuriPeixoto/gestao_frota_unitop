    ...
    <x-slot name="header">
        <div class="flex justify-between items-center mb-4">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Novo Tipo de Fornecedor') }}
            </h2>
            <div class="flex items-center space-x-2">
                <x-button-link href="{{ route('admin.tipofornecedores.index') }}"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo tipo de fornecedor. Preencha o campo de
                                    descrição com o nome do tipo de fornecedor. Após o preenchimento, clique em 'Salvar'
                                    para adicionar o novo tipo ou 'Cancelar' para retornar à lista de tipos.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.tipofornecedores.store') }}" method="POST">
                        @csrf
                        @include('admin.tipofornecedores._form')
                    </form>
                </div>
            </div>
        </div>
