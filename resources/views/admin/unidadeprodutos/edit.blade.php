<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Editar Unidade: ') }} {{ $unidadeProduto->descricao_unidade }}
            </h2>
            <div class="flex items-center space-x-4">
                ...
                <div class="relative inline-block text-left" x-data="{ helpOpen: false }">
                    ...
                    <div x-show="helpOpen" @click.away="helpOpen = false"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm font-medium text-gray-900">Ajuda - Editar Unidade</p>
                                <p class="mt-1 text-xs text-gray-500">
                                    Altere a descrição da unidade conforme necessário. A descrição deve continuar única
                                    no sistema.
                                </p>
                            </div>
                        </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <form action="{{ route('admin.unidadeprodutos.update', $unidadeProduto->id_unidade_produto) }}"
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="text" id="descricao_unidade" name="descricao_unidade" required
                                    ...
                                    value="{{ old('descricao_unidade', $unidadeProduto->descricao_unidade) }}"
