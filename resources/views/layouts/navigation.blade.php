            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo
                            class="w-auto max-w-[157px] h-14 sm:h-16 transition-all dark:brightness-100" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200"
                        ...
                        class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl z-50 max-h-96 overflow-hidden"
                        style="display: none;">
                        ...
                        <div id="notification-dropdown" class="overflow-y-auto max-h-80">
