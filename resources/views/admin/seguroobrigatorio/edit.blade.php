<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Edição de
                                    Seguro Obrigatório</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar um seguro obrigatório existente. 
                                    Altere os campos desejados e clique em "Atualizar" para salvar as modificações.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    @include('admin.seguroobrigatorio._form', [
        'action' => route('admin.seguroobrigatorio.update', $seguroObrigatorio->id_seguro_obrigatorio_veiculo),
        'method' => 'PUT',
