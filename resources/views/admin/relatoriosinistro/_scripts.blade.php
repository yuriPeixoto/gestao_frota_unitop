<script>
    document.addEventListener('alpine:init', () => {
        Alpine.store('relatoriosinistro', {
            loading: false,
            ...
            async gerarPdf() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriosinistro/gerarpdf', dados);
            ...
            async gerarPdfTotalizado() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriosinistro/gerarpdftotalizado', dados);
                    const blob = await response.blob();
            ...
            async gerarExcel() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriosinistro/gerarexcel', dados);
                    const blob = await response.blob();
