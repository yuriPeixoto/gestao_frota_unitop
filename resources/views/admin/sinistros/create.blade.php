<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo sinistro. Preencha todos os
                                    campos obrigatórios na parte superior e adicione uma ou mais pessoas na seção
                                    abaixo.
                                </p>
                            </div>
                        </div>
    ...
    @include('admin.sinistros._form', [
        'action' => route('admin.sinistros.store'),
        'method' => 'POST',
    ])
</x-app-layout>
