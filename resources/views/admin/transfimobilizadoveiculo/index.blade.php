    ...
    <x-slot name="header">
        <div class="flex w-full items-center justify-between">
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                {{ __('Cadastro de Transferência Veículos em Imobilizado ') }}
            </h2>
            <div class="flex items-center space-x-4">
                <a href="{{ route('admin.transfimobilizadoveiculo.create') }}"
                    ...
                    Cadastrar Transferência Veículos
                </a>
    ...
    <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
        <div class="border-b border-gray-200 bg-white p-4">
            <div class="border-b border-gray-200 bg-white p-6">
                ...
                <!-- Search Form -->
                @include('admin.transfimobilizadoveiculo._search-form')
                ...
                <div class="relative mt-6 min-h-[400px] overflow-x-auto">
                    ...
                    <div id="results-table" class="opacity-0 transition-opacity duration-300">
                        @include('admin.transfimobilizadoveiculo._table')
                    </div>
                </div>
            </div>
        </div>
