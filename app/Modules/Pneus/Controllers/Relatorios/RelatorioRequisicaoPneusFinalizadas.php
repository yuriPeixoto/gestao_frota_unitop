...
class RelatorioRequisicaoPneusFinalizadas extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.relatoriorequisicaopneusfinalizadas.index', compact('filiais', 'requisicao'));
    }
    ...
    public function gerarPdf(Request $request)
    {
        ...
        if (!empty($request['data_inclusao']) && !empty($request['data_final'])) {
            ...
            $name  = 'historico_pneu_requisicao_v1';
