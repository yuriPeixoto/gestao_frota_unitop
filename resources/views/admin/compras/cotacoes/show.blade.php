            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="border-b border-gray-200 bg-white p-6">
                    <div class="space-y-6">
                        ...
                        <!-- Informações do Adiamento -->
                        @if ($solicitacao->is_adiado)
                            <div class="overflow-hidden border-l-4 border-orange-400 bg-white shadow sm:rounded-lg">
                                <div class="bg-orange-50 px-4 py-5 sm:px-6">
                                    <div class="flex items-center">
                                        <svg class="mr-3 h-6 w-6 text-orange-600" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <h3 class="text-lg font-medium leading-6 text-orange-900">
                                            Solicitação Adiada
                                        </h3>
                                    </div>
                                    <p class="mt-1 text-sm text-orange-700">
                                        Esta solicitação foi adiada temporariamente.
                                    </p>
                                </div>
                                <div class="border-t border-orange-200 bg-white px-4 py-5 sm:p-0">
                                    <dl class="sm:divide-y sm:divide-gray-200">
                                        <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-5">
                                            <dt class="text-sm font-medium text-gray-500">
                                                Data do Adiamento
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                                {{ $solicitacao->data_adiado ? $solicitacao->data_adiado->format('d/m/Y') : 'N/A' }}
                                            </dd>
                                        </div>
                                        <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-5">
                                            <dt class="text-sm font-medium text-gray-500">
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                                <div class="flex items-center">
                                                    <span>{{ $solicitacao->userAdiado->name ?? 'N/A' }}</span>
                                                </div>
                                            </dd>
                                        </div>
                                        <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-5">
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                                @if ($solicitacao->justificativa_adiado)
                                                    <div class="rounded-lg border border-orange-200 bg-orange-50 p-3">
                                                        <p class="text-sm text-orange-800">
                                                            {{ $solicitacao->justificativa_adiado }}
                                                        </p>
                                                    </div>
                                                @else
                                                    <span class="italic text-gray-500">Nenhuma justificativa
                                                        fornecida</span>
                                                @endif
                                            </dd>
                                        </div>
