<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Cadastrar Recebimento de Combustível') }}
            </h2>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo recebimento de combustível. Preencha todos os
                                    campos obrigatórios e utilize o botão "Buscar Pedido" para carregar automaticamente
                                    os dados do pedido.
                                </p>
                            </div>
                        </div>
    ...
    'action' => route('admin.recebimentocombustiveis.store'),
    'method' => 'POST',
    ])
</x-app-layout>