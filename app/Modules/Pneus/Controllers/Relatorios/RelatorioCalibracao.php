...
class RelatorioCalibracao extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.relatoriocalibracao.index', compact('placas'));
    }
