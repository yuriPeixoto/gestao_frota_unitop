    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            ...
            <div class="flex items-center space-x-4">
                <x-button-link href="{{ route('admin.servicos.create') }}"
