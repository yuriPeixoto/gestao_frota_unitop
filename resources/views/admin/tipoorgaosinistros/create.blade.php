                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo tipo de órgão para sinistros. Preencha o
                                    campo de descrição com o nome do órgão. Após o preenchimento, clique em 'Salvar'
                                    para adicionar o novo registro ou 'Cancelar' para retornar à lista.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.tipoorgaosinistros.store') }}" method="POST">
                        @csrf
