<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Editar Descarte Imobilizado') }}
            </h2>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Edição de
                                    Descarte Imobilizado</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar um Descarte Imobilizado existente. Altere os campos
    ...
    @include('admin.descarteimobilizado._form', [
    'action' => route('admin.descarteimobilizado.update', $descarteImobilizado->id_descarte_imobilizados),
    'method' => 'PUT',
    'descarteImobilizado' => $descarteImobilizado,
    ])
</x-app-layout>