<style>
    ...
    /* Estilos para telas menores ou iguais a 768px (tablets e celulares) */
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Confirmação Faturamento Abastecimento') }}
            </h2>
                        ...
                        <div class="py-1 relative z-50">
                            <div class="absolute top-4 right-4 bg-white shadow-lg rounded-lg px-4 py-2 z-50">
                                <p class="text-sm leading-5 font-medium text-gray-900">
                                    Ajuda - Confirmar Faturamento Abastecimento
                                </p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode Confirmar o Faturamento do Abastecimento. Confirme no botão
                                    'Confirmar Faturamento' para finalizar o Abastecimento selecionado.
                                </p>
                            </div>
                        </div>
