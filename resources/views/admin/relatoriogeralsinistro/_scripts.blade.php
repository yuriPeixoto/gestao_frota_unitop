<script>
    document.addEventListener('alpine:init', () => {
        Alpine.store('relatoriogeralsinistro', {
            loading: false,
            ...
            coletarDadosFormulario() {
                return {
                    ...
                    id_sinistro: document.querySelector('select[name="id_sinistro"], #id_sinistro')?.value || '',
            ...
            async gerarPdf() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriogeralsinistro/gerarpdf', dados);
                    const blob = await response.blob();

                    this.fazerDownload(blob, `relatorio_sinistrogeral${new Date().toISOString().slice(0,10)}.pdf`);
            ...
            async gerarPdfTotalizado() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriogeralsinistro/gerarpdftotalizado', dados);
                    const blob = await response.blob();
            ...
            async gerarExcel() {
                ...
                try {
                   ...
                   if (!this.validarDatas(dados)) return;
                    ...
                    const response = await this.fazerRequisicao('/admin/relatoriogeralsinistro/gerarexcel', dados);
                    const blob = await response.blob();
