<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo teste de frio para um veículo. Preencha todos os
                                    campos obrigatórios marcados com * e anexe o arquivo do laudo se necessário.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="p-4 bg-white rounded">
        <form id="testefriofForm" method="POST" action="{{ route('admin.testefrios.store') }}" 
