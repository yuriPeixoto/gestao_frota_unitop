<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar os dados de um teste de frio existente. Altere os campos
    ...
    <div class="p-4 bg-white rounded">
        <form id="testefriofForm" method="POST" action="{{ route('admin.testefrios.update', $testefrio->id_certificado_veiculo) }}" 
