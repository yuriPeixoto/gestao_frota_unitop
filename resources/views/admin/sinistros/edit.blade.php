<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Editando Sinistro #' . $sinistro->id_sinistro) }}
            </h2>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar um cadastro de sinistro existente. Altere os campos
    ...
    @include('admin.sinistros._form', [
        'action' => route('admin.sinistros.update', $sinistro->id_sinistro),
        'method' => 'PUT',
        'sinistro' => $sinistro,
    ])
</x-app-layout>
