<div class="space-y-4">
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button type="button" x-on:click="$store.relatoriocontacorrentefornecedor.gerarPdf()"
                :disabled="$store.relatoriocontacorrentefornecedor.loading"
                ...
                <span x-show="$store.relatoriocontacorrentefornecedor.loading" class="loading-spinner mr-2"></span>
                <x-icons.magnifying-glass x-show="!$store.relatoriocontacorrentefornecedor.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriocontacorrentefornecedor.loading ? 'Gerando...' : 'Buscar PDF'"></span>
            </button>

            <button type="button" x-on:click="$store.relatoriocontacorrentefornecedor.gerarExcel()"
                :disabled="$store.relatoriocontacorrentefornecedor.loading"
                ...
                <x-icons.magnifying-glass x-show="!$store.relatoriocontacorrentefornecedor.loading"
                    class="h-4 w-4 mr-2" />
                <span x-text="$store.relatoriocontacorrentefornecedor.loading ? 'Gerando...' : 'Buscar Excel'"></span>
            </button>
