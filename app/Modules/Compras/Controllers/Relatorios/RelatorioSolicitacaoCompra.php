...
class RelatorioSolicitacaoCompra extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.relatoriosolicitacaocompra.index', compact('filial', 'departamento'));
    }
        ...
        try {
            ...
            if ($request->filled(['data_inclusao', 'data_final'])) {
                ...
                if (empty($request['id_departamento'])) {
                    ...
                    $in_departamento = 'IN';
                    $id_departamento = implode(',', $request['id_departamento']);
                }
