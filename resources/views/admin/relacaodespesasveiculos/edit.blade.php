<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode editar um despesas veiculos existente. Altere os campos
    ...
    @include('admin.relacaodespesasveiculos._form', [
        'action' => route('admin.relacaodespesasveiculos.update', $manutencaoConfig->id_despesas_veiculos),
        'method' => 'PUT',
