...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Recebimento de Combustíveis') }}
            </h2>
            <div class="flex items-center space-x-4">
                @can('criar_recebimentocombustivel')
                    <a href="{{ route('admin.recebimentocombustiveis.create') }}"
                ...
                <div class="relative inline-block text-left" x-data="{ helpOpen: false }">
                    ...
                    <div x-show="helpOpen" @click.away="helpOpen = false"
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Recebimento de
                                    Combustíveis</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Esta tela exibe os registros de Recebimento de Combustíveis lançados no sistema.
                                    Use os filtros abaixo para buscar registros específicos.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm">
        <div class="p-4 bg-white border-b border-gray-200">
            <div class="p-6 bg-white border-b border-gray-200">
                <!-- Search Form -->
                @include('admin.recebimentocombustiveis._search-form')
                ...
                <div class="mt-6 relative min-h-[400px]">
                    ...
                    <div id="results-table" class="opacity-0 transition-opacity duration-300">
                        @include('admin.recebimentocombustiveis._table')
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('scripts')
        @include('admin.recebimentocombustiveis._scripts')
