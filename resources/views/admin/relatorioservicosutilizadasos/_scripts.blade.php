<script>
    document.addEventListener('alpine:init', () => {
        Alpine.store('relatorioServicosUtilizadasOs', {
            loading: false,
            ...
            async gerarPdf() {
                ...
                try {
                    ...
                    const response = await this.fazerRequisicao('/admin/relatorioservicosutilizadasos/gerarpdf', dados);
                    const blob = await response.blob();

                    this.fazerDownload(blob, `relatorio_servicos_utilizadas_os${new Date().toISOString().slice(0,10)}.pdf`);
            ...
            async gerarExcel() {
                ...
                try {
                    ...
                    const response = await this.fazerRequisicao('/admin/relatorioservicosutilizadasos/gerarexcel', dados);
                    const blob = await response.blob();

                    this.fazerDownload(blob, `relatorio_servicos_utilizadas_os${new Date().toISOString().slice(0,10)}.xls`);
