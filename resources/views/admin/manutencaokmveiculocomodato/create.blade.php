<x-app-layout>
                        ...
                        <div class="py-1">
                            <div class="px-4 py-2">
                                <p class="text-sm leading-5 font-medium text-gray-900 truncate">Ajuda - Cadastro de
                                    Cadastro Km de Comodato</p>
                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                    Nesta tela você pode cadastrar um novo Cadastro Km de Comodato. Preencha todos os
                                    campos obrigatórios.
                                </p>
                            </div>
                        </div>
    ...
    @include('admin.manutencaokmveiculocomodato._form', [
        'action' => route('admin.manutencaokmveiculocomodato.store'),
        'method' => 'POST',
    ])
</x-app-layout>
